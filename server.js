...
app.post('/home',async(req,res)=>{console.log("triggered") 
...
app.post('/post',(req,res)=>{console.log("triggered") 
...
app.post('/search',(req,res)=>{console.log("triggered") 
...
app.post('/userProfile',(req,res)=>{console.log("triggered") 
	const id=req.body.id
	Quser.findOne({_id:id},(err,val)=>{
		res.json({post:val.post,name:val.username})
	})
})
app.post('/publish',(req,res)=>{console.log("triggered") 
